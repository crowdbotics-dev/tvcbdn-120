"""
Django settings for tvcbdn_120 project.
...
WSGI_APPLICATION = 'tvcbdn_120.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tvcbdn_120 API",
    "DESCRIPTION": "API documentation for tvcbdn_120 App",
    "VERSION": "v1",
}
